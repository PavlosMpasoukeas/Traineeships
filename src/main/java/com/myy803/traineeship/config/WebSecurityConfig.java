package com.myy803.traineeship.config;
...
import com.myy803.traineeship.services.UserServiceImpl;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                ...
                http.authorizeHttpRequests(
                        ...
                        .requestMatchers("/admin/**").hasAnyAuthority("ADMIN")//edw leei na exei prosvash mono o admin
